...
let is_relation_tranzitive mp = failwith "Not Implemented";;
...
testExpected (is_relation_tranzitive less_than_1_4) true "less-than is tranzitive";;
testExpected (is_relation_tranzitive less_than_or_equal_1_4) true "less-than-or-equal is tranzitive";;
testExpected (is_relation_tranzitive mod_3_equality) true "mod-3 equality is not tranzitive";;
testExpected (is_relation_tranzitive dummy_relation) false "dummy_relation is not tranzitive";;
