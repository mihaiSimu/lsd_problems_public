...
let is_relation_anti_symmetric mp = failwith "Not Implemented";;
...
testExpected (is_relation_anti_symmetric less_than_1_4) true "less-than is anti-symmetric";;
testExpected (is_relation_anti_symmetric less_than_or_equal_1_4) true "less-than-or-equal is anti-symmetric";;
testExpected (is_relation_anti_symmetric mod_3_equality) false "mod-3 equality is not anti-symmetric";;
testExpected (is_relation_anti_symmetric dummy_relation) false "dummy_relation is not anti-symmetric";;
