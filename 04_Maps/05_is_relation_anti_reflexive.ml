...
let is_relation_anti_reflexive mp = failwith "Not Implemented";;
(* ========================= Tests: =========================== *)
...
let less_than__or_equal_1_4 = create_int_map [
...
testExpected (is_relation_anti_reflexive less_than_1_4) true "less-than is anti-reflexive";;
testExpected (is_relation_anti_reflexive less_than__or_equal_1_4) false "less-than-or-equal is not anti-reflexive";;
testExpected (is_relation_anti_reflexive mod_3_equality) false "mod_3_equality is not anti-reflexive";;
testExpected (is_relation_anti_reflexive dummy_relation) false "dummy_relation is not anti-reflexive";;
