...
(* Function 
  union_of_list_of_sets set_lst

  takes as argument a list-of-sets (set_lst) the unification of all of the sets
  For example, given the list 
  [{5;6;7;8}; {6;7;8;9}, {7;8;9;10}, {8;9;10;11}, {10,11,12,14}]
  
  The functin will rturn the set {5;6;7;8;9;10;11;12;14}
*)
...
let expected_union = IntS.of_list [5;6;7;8;9;10;11;12;14];;

LsdTest.test 
  (IntS.equal (most_frequent_element_list_of_sets lst) expected_union)
  "Union from the example in problem statement";;